...
public class RunDAO implements DataAccessObject {
	...
	public List<Entity> search(List<Entity> searchTerms) {
		...
		searchResult.add(new Run(2,new Date(12,3,2010), 3300, 5.56f, 323, null));
			...
			searchResult.add(new Run(3,new Date(2,3,2010), 5600, 12.56f, 423, null));
			searchResult.add(new Run(4,new Date(3,3,2010), 7600, 23.56f, 523, null));
			searchResult.add(new Run(5,new Date(4,3,2010), 1600, 2.56f, 623, null));
		}
